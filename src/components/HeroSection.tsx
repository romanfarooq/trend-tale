export default function HeroSection() {
  return (
    <section
      id="home"
      className="relative flex h-screen scroll-mt-20 items-center justify-center bg-[url('/src/assets/background.jpg')] bg-cover bg-center"
    >
      <div className="absolute inset-0 z-10 bg-black opacity-70"></div>
      <div className="relative z-20 max-w-2xl px-4 text-center">
        <h1 className="mb-5 bg-gradient-to-r from-[#ff00cc] via-[#7130c3] to-[#410093] bg-clip-text text-4xl font-bold text-transparent md:text-6xl">
